                                        ...
                                        <div class="card-title">
                                            ...
                                            <div class="symbol-group symbol-hover">
                                                ...
                                                <a href="#" class="symbol symbol-35px symbol-circle"
                                                    ...
                                                    <span class="symbol-label fs-8 fw-bold"
                                        ...
                                        <div class="scroll-y me-n5 pe-5 h-300px h-lg-auto"
                                            ...
                                            <div class="d-flex justify-content-end mb-10">
                                                ...
                                                <div class="d-flex flex-column align-items-end">
                                                    ...
                                                    <div class="p-5 rounded bg-light-primary text-gray-900 fw-semibold mw-lg-400px text-end"
                                                        ...
                                                        writing to let
                                                        you know that you’ve been subscribed to a repository on
                                                        GitHub.
                                                    </div>
                                                    <!--end::Text-->
                                                </div>
                                            ...
                                            <div class="d-flex justify-content-end mb-10">
                                                ...
                                                <div class="d-flex flex-column align-items-end">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="p-5 rounded bg-light-primary text-gray-900 fw-semibold mw-lg-400px text-end"
                                                        data-kt-element="message-text">You’ll receive notifications
                                                        for all
                                            ...
                                            <div class="d-flex justify-content-start mb-10">
                                                ...
                                                <div class="d-flex flex-column align-items-start">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="p-5 rounded bg-light-info text-gray-900 fw-semibold mw-lg-400px text-start"
                                                        data-kt-element="message-text">You can unwatch this
                                                        repository
                                            ...
                                            <div class="d-flex justify-content-start mb-10">
                                                ...
                                                <div class="d-flex flex-column align-items-start">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="p-5 rounded bg-light-info text-gray-900 fw-semibold mw-lg-400px text-start"
                                                        data-kt-element="message-text">Company BBQ to celebrate the
                                                        last
                                            ...
                                            <div class="d-flex justify-content-start mb-10 d-none"
                                                ...
                                                <div class="d-flex flex-column align-items-start">
                                                    ...
                                                    <!--begin::Text-->
                                                    <div class="p-5 rounded bg-light-info text-gray-900 fw-semibold mw-lg-400px text-start"
                                                        data-kt-element="message-text">Right before vacation season
                                                        we have
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-6">
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                Bean
                                                                <span
                                                                    class="badge badge-light fs-8 fw-semibold ms-2">Web
                                                                    Developer</span></a>
                                                            <!--end::Name-->
                                                            <!--begin::Email-->
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-6">
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                Collins
                                                                <span
                                                                    class="badge badge-light fs-8 fw-semibold ms-2">Head
                                                                    Of Marketing</span></a>
                                                            <!--end::Name-->
                                                            <!--begin::Email-->
                                                            <div class="fw-semibold text-muted">mik@pex.com</div>
